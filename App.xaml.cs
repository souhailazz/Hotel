    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            serviceCollection.AddDbContext<HotelReservationContext>(options =>
                options.UseSqlServer(@"Server=DESKTOP-5ITJ9LT\SQLEXPRESS;Database=HotelReservationDB2;Trusted_Connection=True;TrustServerCertificate=True;"));
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            // Show the LoginWindow at startup
